# FEM Multi-Agent RAG Simulator

A multi-agent, retrieval-augmented workflow for generating, running, repairing, and validating FEniCS 2019.1.0 simulation scripts.
